...
// Example: LCAlertView().showSuccess(self, title: "Test", subTitle: "Value").close()
open class LCAlertViewResponder {
    let alertview: LCAlertView
    
    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: LCAlertView) {
...
let uniqueAccessibilityIdentifier: String = "LCAlertView"

public typealias DismissBlock = () -> Void

// The Main Class
open class LCAlertView: UIViewController {
    ...
    fileprivate var selfReference: LCAlertView?
    ...
    fileprivate func setup() {
        ...
        if appearance.disableTapGesture == false {
            let tapGesture = UITapGestureRecognizer(target: self, action: #selector(LCAlertView.tapped(_:)))
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(LCAlertView.keyboardWillShow(_:)), name:NSNotification.Name.UIKeyboardWillShow, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(LCAlertView.keyboardWillHide(_:)), name:NSNotification.Name.UIKeyboardWillHide, object: nil);
    }
    ...
    open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showTimeout:LCButton.ShowTimeoutConfiguration? = nil, action:@escaping ()->Void)->LCButton {
        ...
        btn.action = action
        btn.addTarget(self, action:#selector(LCAlertView.buttonTapped(_:)), for:.touchUpInside)
        btn.addTarget(self, action:#selector(LCAlertView.buttonTapDown(_:)), for:[.touchDown, .touchDragEnter])
        btn.addTarget(self, action:#selector(LCAlertView.buttonRelease(_:)), for:[.touchUpInside, .touchUpOutside, .touchCancel, .touchDragOutside] )
        return btn
    }
    ...
    //Dismiss keyboard when tapped outside textfield & close LCAlertView when hideWhenBackgroundViewIsTapped
    ...
    @discardableResult
    open func showCustom(_ title: String, subTitle: String, color: UIColor, icon: UIImage, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showSuccess(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showError(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.error.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showNotice(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.notice.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showWarning(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.warning.defaultColorInt, colorTextButton: UInt=0x000000, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showInfo(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showWait(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt?=LCAlertViewStyle.wait.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showEdit(_ title: String, subTitle: String, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt=LCAlertViewStyle.edit.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, style: LCAlertViewStyle, closeButtonTitle:String?=nil, timeout:LCTimeoutConfiguration?=nil, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
    ...
    @discardableResult
    open func showTitle(_ title: String, subTitle: String, timeout: LCTimeoutConfiguration?, completeText: String?, style: LCAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: LCAnimationStyle = .topToBottom) -> LCAlertViewResponder {
        selfReference = self
        view.alpha = 0
        view.tag = uniqueTag
        ...
        case .success:
            ...
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: LCAlertViewStyleKit.imageOfCheckmark)
            
        case .error:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage: LCAlertViewStyleKit.imageOfCross)
            
        case .notice:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertViewStyleKit.imageOfNotice)
            
        case .warning:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertViewStyleKit.imageOfWarning)
            
        case .info:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertViewStyleKit.imageOfInfo)
            
        case .edit:
            
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertViewStyleKit.imageOfEdit)
            
        case .wait:
            iconImage = nil
            
        case .question:
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:LCAlertViewStyleKit.imageOfQuestion)
        }
        ...
        if appearance.showCloseButton {
            _ = addButton(completeText ?? "取消", target:self, selector:#selector(LCAlertView.hideView))
        }
        ...
        if let timeout = timeout {
            ...
            timeoutTimer = Timer.scheduledTimer(timeInterval: timeout.value, target: self, selector: #selector(LCAlertView.hideViewTimeout), userInfo: nil, repeats: false)
            showTimeoutTimer?.invalidate()
            showTimeoutTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(LCAlertView.updateShowTimeout), userInfo: nil, repeats: true)
        }
        ...
        // Chainable objects
        return LCAlertViewResponder(alertview: self)
    }
    ...
    @objc open func hideView() {
        UIView.animate(withDuration: 0.2, animations: {
            ...
            // This is necessary for LCAlertView to be de-initialized, preventing a strong reference cycle with the viewcontroller calling LCAlertView.
    ...
    //Return true if a LCAlertView is already being shown, false otherwise
...
class LCAlertViewStyleKit : NSObject {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        LCAlertViewStyleKit.drawCheckmark()
    ...
    class var imageOfNotice: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        LCAlertViewStyleKit.drawNotice()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        LCAlertViewStyleKit.drawWarning()
    ...
    class var imageOfQuestion: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        LCAlertViewStyleKit.drawQuestion()
